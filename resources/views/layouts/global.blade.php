...
<head>
  ...
  <title>Sensus Penduduk @yield("title")</title>
  <link rel="stylesheet" href="{{asset('polished/polished.min.css')}}">
  <link rel="stylesheet" href="{{asset('polished/iconic/css/open-iconic-bootstrap.min.css')}}">
  <link rel="shortcut icon" href="{{asset('polished/shop.ico')}}">
                ...
                <div style="min-height: 100%" class="flex-row d-flex align-items-stretch m-0">
                    <div class="polished-sidebar bg-light col-12 col-md-3 col-lg-2 p-0 collapse d-md-inline" id="sidebar-nav">
                        ...
                        <ul class="polished-sidebar-menu ml-0 pt-4 p-0 d-md-block">
                          ...
                          <li><a href="{{route('regions.index')}}"><span class="oi oi-tag"></span> Manage Region</a></li>
                          <li><a href="{{route('persons.index')}}"><span class="oi oi-tag"></span> Manage Person</a></li>
